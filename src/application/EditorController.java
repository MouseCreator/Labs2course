...
public class EditorController extends AttachedToStudySetIndexController implements Initializable{
    ...
    @FXML
    private Button pushTermDownBtn;

    @FXML
    private Button pushTermUpBtn;
    ...
    @FXML
    private Button saveAndLearnBtn;
    ...
    private LinkedList<EditItemController> controllerList = new LinkedList<>();

    public void setKeyEvent() {
    	rightScrollPane.setOnKeyPressed(new EventHandler<KeyEvent>() {
	...
	public EditorController(WorkspaceController parent) {
		super(parent);
	}
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		termCreatorList.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<Pane>() {

			@Override
			public void changed(ObservableValue<? extends Pane> arg0, Pane arg1, Pane arg2) {
	...
	public FXMLLoader loadItem()throws IOException  {
		...
		itemLoader.setLocation(getClass().getResource("SetEditItem.fxml"));
	...
	public void deleteSetAndConfirm() {
		this.getParent().displayDeletionPopUp(()->deleteSet());
	}
	
	private void saveUnsavedChangesConfirm() {
		this.getParent().displaySavingPopUp(()->onSaveAndClose(), ()->onNotSaveAndClose());
	}
