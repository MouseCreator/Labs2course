...
public class FileBuilder {
    ...
    private static final String DATA_FOLDER = "data" + separator;
    ...
    private static final String GPACHICS_FOLDER = "gfx" + separator;
    ...
    private static final String SET_GARBAGE_FILENAME = "sgarbage";
    private static final String FOLDER_GARBAGE_FILENAME = "fgarbage";
    ...
    private static String gfx() {
    	return FILE_DET + DATA_FOLDER + GPACHICS_FOLDER ;
    }
    ...
    public static String getStudySetGarbageFileName() {
        return DATA_FOLDER + SET_GARBAGE_FILENAME + INDEX_EXTENSION;
    }
    public static String getFolderGarbageFileName() {
        return DATA_FOLDER + FOLDER_GARBAGE_FILENAME + INDEX_EXTENSION;
    }
    ...
    public static FolderList readFolderIndexList() {
    	...
    	try {
            ...
            while (scanner.hasNextLine()) {
            	...
            	result.add(new Folder(Integer.valueOf(id), 
